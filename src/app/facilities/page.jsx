...
export default async function FacilitiesPage({ searchParams }) {
  ...
  const facilities = await getFacilities(search, sportType);
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0B1528] via-slate-950 to-slate-950 text-white py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {!facilities || facilities.length === 0 ? (
          <div className="text-center py-16 border border-white/5 bg-white/[0.01] backdrop-blur-md rounded-3xl max-w-md mx-auto">
            ...
            <p className="text-slate-400 font-medium">No facilities match your search criteria.</p>
            <p className="text-slate-600 text-xs mt-1">Try resetting the filters or typing something else.</p>
          </div>
        ) : (
